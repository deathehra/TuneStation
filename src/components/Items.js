    ...
    return (
        ...
        <div id={props.song.id}>
            ...
            <div onClick={props.onClick} className="group relative flex items-center gap-3  p-2 sm:p-3 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition cursor-pointer" >
                <img alt="thumbnail"
                    className="className="w-12 h-12 sm:w-14 sm:h-14 rounded-full object-cover flex-shrink-0"
                ...
                <div className="flex-grow">
                    ...
                    <p <p className="text-xs sm:text-sm truncate text-gray-600 dark:text-gray-400">{props.song.primaryArtists ? props.song.primaryArtists : props.song.artist}</p>
                </div>
